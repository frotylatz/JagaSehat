...
public class MateriDukunganActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titleMateri = findViewById(R.id.titleMateriDukungan);
        titleMateri.setVisibility(View.VISIBLE);
        titleMateri.setText("Ibu Tidak Sendirian");
        ...
        buttonFinish.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MateriDukunganActivity.this, MainActivity.class);
        ...
        mSlideViewPager.setAdapter(new DukunganAdapter(this));
